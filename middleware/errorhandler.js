    ...
    switch (error.response.status) {
      case 403:
        return createJsonResponse(
          response,
          403,
          "Invalid Hypixel API token provided"
        );
      ...
      case 502:
        return createJsonResponse(
          response,
          502,
          "Hypixels API is currently experiencing some technical issues, try again later"
        );
      ...
      case 521:
        return createJsonResponse(
          response,
          503,
          "Hypixels API is currently in maintenance mode, try again later"
        );
    }
  }
